...
save_dir = '/data/data1/zhangboshen/CODE/AstroData/2D_conv/save_weights/with_valdata_se'
...
np.save(save_dir+'/ext_2_pred_9843.npy',estimation)
pre_label_all = list(np.argmax(estimation, axis = 1))
np.save(save_dir+'/pre_label_se.npy',pre_label_all)